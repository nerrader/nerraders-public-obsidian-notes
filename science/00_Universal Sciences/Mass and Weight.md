...
The **SI Unit** for Mass is a **kilogram (kg)**
...
> [!INFO] Weight's Formula
> 
> $W = m*g$
> $m$ = mass
> $g$ = gravitational field strength.
> 
We can verify the previous statement by plugging in the values, g = 0
> If g = 0, then Weight (W) is also automatically equal to 0.

The SI unit for Weight is **Newtons (N)**

> [!CAUTION] Mass vs Weight
> 
> Mass is a constant, that means wherever you are in the universe mass stays the same.
> 
> Weight, however is not a constant. It is derived from the gravitational field strength of wherever you are at.
> 
