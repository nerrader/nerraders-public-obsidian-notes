...
A moment (measured in $Nm$), is the turning effect of a force around a pivot
The formula to calculate a moment is just:

Moment = force  * perpendicular distance to the fulcrum/pivot
$M = N*d$

> [!INFO] Levers in Equilibrium
If a lever is straight and balanced, that means the clockwise moment is equal to the anticlockwise moment.
...
basically:
- First Class: pivot/fulcrum in the middle
