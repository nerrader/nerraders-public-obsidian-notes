...
These types of rocks are also categorized into two categories:

- **Foliated Rocks**: Rocks that are layered or banded due to directed pressure and heat. (e.g slate)
- **Non-Foliated Rocks**: Rocks that lack the layered structure, form when pressure is uniform or from the recrystallization of certain materials. (e.g. marble)
...
- **Frost Wedging (Freeze Thaw)**: This type of weathering works by the continuous freezing and melting of water in rocks. As water freezes, it expands and forces the rock pores to crack and make space, and over time, after it melts and freezes over and over again, it can finally cause the rock to crack and split.
- **Thermal Expansion:** During the day, solar radiation heats the rock's outer surface, causing it to expand more than the cooler interior. At night, the surface cools and contracts faster than the inner layers. This differential expansion and contraction creates **shear stress** and internal forces that cause the rock to crack.
...
This process is usually driven by oxygen, water, or carbon dioxide. Common mechanisms include:

- **Hydrolysis**: Acidic water reacts with silicate materials to form clay and dissolved ions.
- **Oxidation**: Oxygen reacts with iron rich materials, creating oxides (rust) that weaken the structure.
- **Dissolution**: Minerals like calcite in limestone dissolve entirely in acidic water, releasing ions into solution
- **Carbonation**: Carbon dioxide in rainwater forms weak carbonic acid, which accelerates the dissolution of carbonate rocks.

> [!INFO]- (Pearson) Acid Rain
>
...
For example, the breaking down of rocks through tree roots cracking into them.

## Erosion

Erosion is when natural forces such as wind, ice, water, and gravity wear away and transport rocks and soil. While weathering only breaks down rocks without moving them, erosion breaks them down and transports them elsewhere.

This process works alongside weathering and deposition to continuously **reshape Earth's landforms**, creating features such as canyons, valleys, and coastlines.
