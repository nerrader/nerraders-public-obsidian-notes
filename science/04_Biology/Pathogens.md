...
- **Live-attenuated vaccines** use a weakened form of the germ, providing strong, long-lasting immunity with one or two doses.
- **Inactivated vaccines** use a killed version of the germ. They are safer for immunocompromised individuals but often require booster doses.
- **Subunit, recombinant, polysaccharide, and conjugate vaccines** use specific pieces of the germ, such as proteins or sugars. These types of vaccines are safe for most people, including those with weakened immune systems.
- **Toxoid vaccines** use a harmless version of the toxin (harmful product) made by the germ, targeting diseases caused by bacterial toxins.
- **Messenger RNA (mRNA) vaccines** instruct cells to produce a protein that triggers an immune response.  They do not contain live virus and allow for rapid development.
- **Viral vector vaccines** use a modified, harmless virus to deliver genetic instructions into cells.

> [!EXAMPLE] Example vaccines for each type
> 
> - **Live-attenuated**: MMR (measles, mumps, rubella), rotavirus, smallpox, chickenpox, and yellow fever
> - **Inactivated vaccines**: Hepatitis A, flu shots, polio, and rabies
> - Subunit, recombinant, polysaccharide, and conjugate vaccines: Hepatitis B, HPV, Hib, pneumococcal, meningococcal
> - Toxoid Vaccines: diphtheria, tetanus
> - mRNA Vaccines: Corminality, Spikevax
> - Viral vector vaccines: Ebola, AstraZeneca and Johnson & Johnson COVID-19 vaccines
